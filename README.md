...
# I only changed the API endpoint to Groq openai compatible endpoint. You can use it with your groq API key and the opensource models on Groq. The rest is the same.
